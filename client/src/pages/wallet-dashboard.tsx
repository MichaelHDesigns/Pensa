...
const WalletDashboard = () => {
  ...
  const processTransaction = (
    tx: solanaWeb3.ParsedTransactionWithMeta,
  ): TransactionData => {
      ...
      try {
        ...
        if (
          ...
          if (walletIndex >= 0) {
            ...
            const balanceDiff =
              (postBalance - preBalance) / solanaWeb3.LAMPORTS_PER_SOL;
            ...
            if (balanceDiff > 0) {
              ...
              for (
                ...
                if (
                  ...
                  fromAddress =
                    tx.transaction.message.accountKeys[i].toString();
                  break;
                }
              }
    ...
    if (tx.slot && tx.blockTime) {
      ...
      confirmations = Math.max(
        1,
        Math.min(Math.floor(secondsElapsed / 0.4), 1000),
      );
    }
    ...
    <div className="max-w-5xl mx-auto bg-[rgba(169,0,232,0.05)]">
      ...
      <Card className="mb-8 neumorphic bg-white">
        <CardContent className="pt-4">
          <h3 className="font-medium mb-4 px-2 text-[rgba(169,0,232,1)]">
            Quick Actions
          </h3>
      ...
      <Card className="mb-8 neumorphic bg-white">
        <CardContent className="pt-4">
          <div className="flex justify-between items-center mb-4 px-2">
            <h3 className="font-medium text-[rgba(169,0,232,1)]">
              Transaction History
            </h3>
            <Link
              href="/transactions"
              className="text-sm text-[rgba(169,0,232,1)] hover:underline flex items-center gap-1 font-medium"
            >
              View All
            </Link>
          </div>
